...
(function ($) {
    ...
    Drupal.views.ajaxView = function(settings) {
        ...
        if (settings.view_name == 'isearch_directory') {
            // use our custom ajax path
            ajax_path = '/isearch/views/ajax';
        } else if (ajax_path.constructor.toString().indexOf("Array") != -1) {
    ...
    Drupal.views.ajaxView.prototype.attachPagerAjax = function() {
        ...
        var alphas = this.$view.parent().find('.asu-isearch-alpha-bar li');
        alphas.each(jQuery.proxy(this.attachAZIndexAjax, this));
    };
    ...
    Drupal.views.ajaxView.prototype.attachPagerLinkAjax = function(id, link) {
        ...
        var select = this.element_settings.selector;
        ...
        // append our custom configs to the exposed values
    ...
    Drupal.views.ajaxView.prototype.attachAZIndexAjax = function(id, link) {
        ...
        this.indexAjax = new Drupal.ajax(false, $link, this.element_settings);
    };
